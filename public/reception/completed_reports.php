            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="completed_reports.php">Completed Reports</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Completed Reports</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Completed Sample's Test Reports
            <small>View recently completed reports</small>
        </h1>
        <!-- end page-header -->
        <!-- start notification  -->
        <?php 
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-general-3">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Completed Sample Test Reports : <span class="limit_reports"></span> out of <span class="completed_reports_count"></span></h4>
                    </div>
                    <div class="panel-body completed_reports">
...
<script src="../assets/js/reception_dashboard/reception_completed_reports_page.js"></script>
