...
$status = 'submitted';
$sample_count=get_samples_count_by_status($status);
...
<head>
    <meta charset="utf-8"/>
    <title>Unprocessed Samples</title>
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Unprocessed Samples</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Unprocessed Samples
            <small>Unconfirmed samples which are not transferred to labs accidently</small>
        </h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Unprocessed Samples : <?php echo $sample_count;?></h4>
                    </div>
                    <!-- start notification  -->
                    <?php 
//                 display query errors or query success if any
                    ...
                    <div class="panel-body">
                       <?php 
                        if($sample_count==0){
                            echo "<p class=\"text-center\">No Unprocessed Samples Found</p>";
                        }
                        else { ?>
                    ...
                    while($sample = mysqli_fetch_assoc($samples)) { ?>
                      <tr>
                        ...
                        <span><a href="operations/delete_customer_sample_record.php?customer_id=<?php echo urlencode($sample["customer_id"]); ?>"><i class="fa fa-trash-o fa-lg"></i> &nbsp;Delete</a></span>
                        </td>
                        </tr>
                       <?php } ?>      
                            </tbody>
