...
//   we are using trash feature just for receiving box in the whole project
        $total_rows = count_trash_messages($table);
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $trash_messages = get_trash_messages($table,$offset,
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="message_trash.php">Trash</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
            ...
            <div class="vertical-box-column width-250">
                ...
                <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-stacked nav-sm">
                        ...
                        <li class="active"><a href="message_trash.php"><i class="fa fa-trash fa-fw m-r-5"></i> Trash</a></li>
                ...
                <div class="wrapper bg-silver-lighter">
                    ...
                    <div class="btn-toolbar">
                      <div class="email-btn-row hidden-xs">
                        ...
                        <a id="deleteDrafts" href="operations/delete_all_trash_messages.php" class="btn btn-sm btn-danger <?php if($total_rows==0) echo "disabled"; ?>" data-toggle="tooltip" title="Click to delete all trash messages"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete All</a>
...
//                 display query errors or query success if any
                ...
                <ul class="list-group list-group-lg no-radius list-email">
                    <?php  
                        while($message = mysqli_fetch_assoc($trash_messages)){
                            $time_string = get_time_diff_from_now($message['timestamp']);
                            $sender= $message['sender'];
                            $receiver= $message['receiver'];
                            ?>
                            
                    <li class="list-group-item <?php if($sender=='admin'){echo 'primary';} else{echo 'inverse';} ?>">
                        
                        <a href="view_trash_detail.php?id=<?php echo $message['id']; ?>" class="email-user">
                           <?php $path = get_user_picture_path($sender);?>
                            <img src="<?php echo $path; ?>" alt="sender picture"/>
                        </a>
                        <div class="email-info">
                            
                             <a href="operations/delete_trash_message.php?id=<?php echo $message['id']; ?>" class="email-time m-r-2" data-toggle="tooltip" title="Click to delete trash message permanently"><i class="fa fa-trash fa-lg"></i></a>
                             
                             <a href="view_trash_detail.php?id=<?php echo $message['id']; ?>" class="email-time" data-toggle="tooltip" title="Click to view the trash message"><i class="fa fa-eye fa-lg"></i></a> 
                             
                            <h5 class="email-title">
                                <a href="view_trash_detail.php?id=<?php echo $message['id']; ?>"><?php echo ucfirst($message['subject']); ?></a>
