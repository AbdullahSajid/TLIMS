...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        <li class="active"><a class="pending_reports_sub_indicator" href="pending_reports.php">Pending Reports</a></li>
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Pending Sample's Test Reports
            <small>View pending reports</small>
        </h1>
        <!-- end page-header -->
        <!-- start notification  -->
                    <?php 
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-general-3">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Pending Sample Test Reports : <span class="pending_reports_count"></span></h4>
                    </div>
                    <div class="panel-body pending_reports">
...
<script src="../assets/js/reception_dashboard/reception_pending_reports_page.js"></script>
