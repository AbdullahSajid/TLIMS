...
if (isset($_POST['submit'])) {
  ...
  // validations
    $fields = array("cname","city","organization","phone","email","sample_color","customer_ref","payment","payment_received","expected_date");
...
<head>
    <meta charset="utf-8"/>
    <title>Add Commercial Sample</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        <li class="active"><a href="add_commercial_sample.php">Add Commercial Sample</a></li>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Add Commercial Sample</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Commercial Testing Request Form
            <small>Add commercial sample record</small>
        </h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Commercial Sample Record</h4>
                </div>
                 <!-- start notification  -->
                    <?php 
...
//                 display query errors or query success if any
                ...
                <form action="add_commercial_sample.php" method="POST" name="form-wizard" enctype="multipart/form-data">
                    <div id="wizard">
                        <ol>
                            <li>
                                Customer Detail
                                   ...
                                   <div class="col-md-2">
                                       <div class="row">
                                           <div class="col-md-12">
                                               ...
                                               <small><a href="add_commercial_sample.php?prev_record=1">Insert previous record</a></small>
                                               </div>
                                            </div>
                                       </div>
                                   </div>
