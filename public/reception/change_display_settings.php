...
if (isset($_POST['submit'])) {
    ...
    $destination = __DIR__ . '/../assets/img/users_pics/reception/';
    try {
                        ...
                        <div class="table-responsive">
                            <table class="table table-profile">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="p-l-3" type="text" name="full_name" value="<?php echo $reception['name']; ?>" required/>
                                    </td>
                                </tr>
                                </thead>
                                <tbody>
                                <tr class="highlight">
                                    ...
                                    <td><input class="p-l-3" type="text" name="username" value="<?php echo $reception['username']; ?>" required/></td>
                                </tr>
                                <tr>
                                    <td class="field">Email</td>
                                    <td><input size="30" class="p-l-3" type="email" name="email" value="<?php echo $reception['email']; ?>" required/></td>
                                </tr>
                                ...
                                <tr class="highlight">
                                    ...
                                    <td><?php echo beautify_fieldname($reception['privileges']); ?></td>
                                </tr>
