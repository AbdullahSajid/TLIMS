...
if(isset($_GET['lab'])){
    ...
    $_SESSION["message"] = "Lab is undefined";
...
<head>
    <meta charset="UTF-8"/>
    <title><?php echo $beautify_lab; ?> Pending Samples</title>
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Lab Pending Samples</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header"><?php echo $beautify_lab; ?> Pending Samples
            <small>View pending samples</small>
        </h1>
        <!-- end page-header -->
         <!-- begin row -->
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-general-3">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title"><?php echo $beautify_lab; ?> Pending Samples : <span class="lab_pending_samples_count"></span></h4>
                    </div>
                    <div class="panel-body lab_pending_samples">
        ...
        <!-- end row -->
      <!-- used by js file-->
      <input type="hidden" id="lab" name="lab" value="<?php echo $lab;?>"/>
    </div>
    <!-- end #content -->
...
<script src="../assets/js/reception_dashboard/reception_lab_pending_samples_page.js"></script>
