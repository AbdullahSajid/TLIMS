...
if(isset($_POST['filter'])){
    ...
    if($type!='both'){
      $query .= "AND type='{$type}' ";  
        ...
        $query .= "AND type IN('commercial','academic commercial') ";
    }
    if($lab!='all'){
      $query .= "AND lab='{$lab}' ";  
    }
...
<head>
    <meta charset="UTF-8"/>
    <title>View Commercial customers</title>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="view_commercial_customers.php">Commercial Customers</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Commercial customers</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Commercial customers
            <small>Filter Commercial Customers</small>
        </h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">
                            ...
                            else echo 'Filter Commercial Customers';
                            ?>
                        </h4>
                    </div>
                    <div class="panel-body">
                        <form action="view_commercial_customers.php" method="POST">
                        <!-- begin row -->
                             ...
                             <div class="form-group col-6 col-sm-6 col-md-6">
                                <label for="customer_type" class="control-label">Customers Type *</label>
                                    <select class="form-control" id="customer_type" name="customer_type" required>
                                          ...
                                          <option value="academic commercial" <?php if($type=='academic commercial') echo "selected";?>>Academic Commercial</option>
                                          <option value="both" <?php if($type=='both') echo "selected";?>>Both Commercial &amp; Academic Commercial</option>
                                    </select>
                        ...
                        <table id="data-table" class="table table-striped table-bordered">
                           ...
                           <?php 
                            ...
                            <tr>
                                ...
                                <td><?php echo $cus['organization']; ?></td>
