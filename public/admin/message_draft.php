...
// we are just using draft feature for only sending messages in whole project
        $total_rows = count_draft_messages($table);
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $draft_messages = get_draft_messages($table,$offset,
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="message_draft.php">Draft</a></li>
            ...
            <div class="row">
                ...
                <!-- end wrapper -->
                    ...
                    <div class="hidden-sm hidden-xs">
                        ...
                        <li class="active"><a href="message_draft.php"><i class="fa fa-pencil fa-fw m-r-5"></i> Drafts</a></li>
                ...
                <div class="col-md-10">
                    <div class="email-btn-row hidden-xs">
                        ...
                        <a id="deleteDrafts" href="operations/delete_all_draft_messages.php" class="btn btn-sm btn-danger <?php if($total_rows==0) echo "disabled"; ?>" data-toggle="tooltip" title="Click to delete all draft messages"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete All</a>
                        
                    </div>
                    <!-- start notification  -->
                    <?php 
//                 redirecting from 'delete_all_draft_messages.php'
//                 display query errors or query success if any
                    ...
                    <div class="email-content">
                        <table class="table table-email">
                            ...
                            <tbody>
<!--     
For time difference help
https://stackoverflow.com/questions/1363920/calculate-days-since-a-timestamp
-->
<!--https://stackoverflow.com/questions/7474762/php-get-how-many-days-and-hours-left-from-a-date-->
                            <?php  
                        while($message = mysqli_fetch_assoc($draft_messages)){
                            
                            $time_string = get_time_diff_from_now($message['timestamp']);
                            
                            $receivers=explode("@",$message['receiver']);
                            if(count($receivers)==1){
                                $receiver_string = beautify_fieldname($message['receiver']);
                            }
                            else{
                                $total = count($receivers);
                                $receiver_string = "{$total} Recipients";
                            }
                            ?>
                            <tr>
                                <td class="message-receivers">
                                   <?php echo $receiver_string; ?>
                                </td>
                                <td class="message-subject">
                                    
                                    <?php echo ucfirst($message['subject']);  ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="view_draft_detail.php?id=<?php echo $message['id']; ?>" class="email-btn" data-toggle="tooltip" title="Click to view the draft message"><i class="fa fa-eye"></i></a> 
                                    
                                    <a href="operations/send_draft_to_recepients.php?id=<?php echo $message['id']; ?>" class="email-btn m-l-1" data-toggle="tooltip" title="Click to send the draft message to recepient"><i class="fa fa-send"></i></a> 
                                                   
                                    <a href="operations/delete_draft_message.php?id=<?php echo $message['id']; ?>" class="email-btn m-l-1" data-toggle="tooltip" title="Click to delete the draft message permanently"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                            </tbody>
