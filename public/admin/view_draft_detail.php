...
<?php
    ...
    if (isset($_GET['id'])) {
      ...
      if ($draft_message = mysqli_fetch_assoc($result)) {
            ...
            // time string
            $time_string = get_time_diff_from_now($draft_message['timestamp']);
...
<head>
<meta charset="UTF-8"/>
    <title>Draft Message Detail</title>
            ...
            <div class="vertical-box-column bg-white">
                ...
                <div class="wrapper bg-silver-lighter clearfix">
                    <div class="btn-group m-r-5">
                        <a href="message_draft.php" class="btn btn-white btn-sm" data-toggle="tooltip" title="Go back"><i class="fa fa-arrow-left"></i></a>
                    </div>
                    <div class="btn-group m-r-5">
                        <a href="operations/delete_draft_message.php?id=<?php echo $id; ?>" class="btn btn-white btn-sm p-l-20 p-r-20" data-toggle="tooltip" title="Delete this draft"><i class="fa fa-trash"></i></a>
                        <a href="operations/send_draft_to_recepients.php?id=<?php echo $id; ?>" class="btn btn-white btn-sm p-l-20 p-r-20" data-toggle="tooltip" title="Send this draft to recepients"><i class="fa fa-send"></i></a>
                    </div>
                    <div class="pull-right">
                        ...
                        <div class="btn-group m-l-5">
                            <a href="message_draft.php" class="btn btn-white btn-sm" data-toggle="tooltip" title="Click to close the draft"><i class="fa fa-times"></i></a>
                        </div>
                    </div>
                </div>
                <!-- end wrapper -->
                        ...
                        <li class="media media-sm clearfix">
                            <a href="javascript:;" class="pull-left">
                               <?php if($total_recepients==1){
                                $path = get_user_picture_path($all_receivers[0]);
                                }
                            ...
                            <div class="media-body">
                                    ...
                                    class="fa fa-clock-o fa-fw"></i> <?php echo $time_string; ?></span><br/>
                                <span class="email-to">
                                        To: <?php
