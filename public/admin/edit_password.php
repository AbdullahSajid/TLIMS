...
if (isset($_POST['submit'])) {
  ...
  $fields_with_max_lengths = array("old_password"=>30,"new_password"=>30);
  ...
  if (empty($errors)) {
    ...
    if(password_check($old_password,$new_password)){
         $_SESSION["message"] = "Current and New paswords entered are same";
        // redirect to itself to show session error message
         redirect_to("edit_password.php");
    }   
      
    $admin = authenticate_admin_old_password($old_password);
    ...
    $result = edit_admin_password($new_password);
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        <li class="active"><a href="edit_password.php">Change Password</a></li>
                        <li><a href="change_display_picture.php">Change Display Picture</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Edit Password
            <small>Edit admin password</small>
        </h1>
        <!-- end page-header -->
         <!-- begin row -->
        <div class="row">
...
//                 display query errors or query success if any
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="edit_password.php" method="post">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Username :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="fullname" name="fullname"
                                           placeholder="Username" value="Ahsan" disabled/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="confirm_password">New Password * :</label>
                                <div class="col-md-6 col-sm-6">
