...
<head>
    <meta charset="utf-8"/>
    <title>Manage Test Prices</title>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="manage_tests_detail.php">Manage Test Prices</a></li>
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Manage Test Prices</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Test Prices
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Test Prices</h4>
                    </div>
                    <!-- start notification  -->
                    <?php 
