...
<!--
                    ...
                    <ul class="nav nav-pills nav-stacked nav-sm m-b-0">
                        <li><a href="javascript:;"><i class="fa fa-fw m-r-5 fa-circle text-primary"></i> Reception </a></li>
                        <li><a href="javascript:;"><i class="fa fa-fw m-r-5 fa-circle text-success"></i> Labs </a></li>
                    </ul>
-->
                </div>
                <!-- end wrapper -->
