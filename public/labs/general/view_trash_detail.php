...
if (isset($_GET['id'])) {
          ...
          $id = $_GET['id'];
          $result= get_trash_message($id,$table);
    
      if ($trash_message = mysqli_fetch_assoc($result)) {
            $id = $trash_message["id"];
            $subject = $trash_message["subject"];
            $content = $trash_message["content"];
            $sender = $trash_message["sender"];
            $receiver = beautify_fieldname($trash_message['receiver']);
            // time string
            $time_string = ' ';
            $time_string .= get_time_diff_from_now($trash_message['timestamp']);
...
<head>
    <meta charset="utf-8"/>
    <title>Trash Message Detail</title>
            ...
            <div class="vertical-box-column bg-white">
                ...
                <div class="wrapper bg-silver-lighter clearfix">
                    <div class="btn-group m-r-5">
                        <a href="message_trash.php" class="btn btn-white btn-sm" data-toggle="tooltip" title="Go back"><i class="fa fa-arrow-left"></i></a>
                    </div>
                    <div class="btn-group m-r-5">
                        <a href="operations/delete_trash_message.php?id=<?php echo $id; ?>" class="btn btn-white btn-sm p-l-20 p-r-20" data-toggle="tooltip" title="Delete trash message"><i class="fa fa-trash"></i></a>
                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group m-l-5">
                            <a href="message_trash.php" class="btn btn-white btn-sm" data-toggle="tooltip" title="Click to close the trash"><i class="fa fa-times"></i></a>
                        </div>
                    </div>
                </div>
                <!-- end wrapper -->
