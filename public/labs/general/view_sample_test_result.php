...
if(isset($_GET['sample_id'])&&isset($_GET['test'])){
    ...
    if(!$test_table_exists){
        ...
        redirect_to("lab_completed_samples.php");
    }
    $sample_test=get_test($sample_id,$test);
    if($sample_test['status']!='finished'){
         $_SESSION["message"] = "Sample Test Results not completed";
         redirect_to("lab_pending_samples.php");
    }   
}
else{
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">View Test Result</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">View Sample Test Result
            <small>View sample test description and results</small>
        </h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-typography-14">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">View <?php echo $test_name; ?>  Test Result</h4>
                    </div>
                        <!-- start notification  -->
                    <?php 
                          ...
                          <!-- begin col-6 -->
                           <div class="col-6 col-md-6">
                            <dl class="dl-horizontal">
                                ...
                                <?php 
                                $sample_description = [];
                                if($sample['sample_color']){$sample_description[]=ucwords($sample['sample_color']);
                                 }  
                                 if($sample['sample_style']){$sample_description[]=ucwords($sample['sample_style']);
                                 } 
                                 if($sample['sample_weight']){$sample_description[]=ucwords($sample['sample_weight']);
