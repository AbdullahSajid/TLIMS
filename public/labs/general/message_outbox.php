...
$user = get_user_info($lab);
    ...
    if (isset($_GET['pageno'])) {
        ...
        $total_rows = count_sent_messages($table);
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $sent_messages = get_sent_messages($table,$offset,
            ...
            <div class="row">
                ...
                <!-- end wrapper -->
                    ...
                    <div class="hidden-sm hidden-xs">
                        ...
                        <li class="active"><a href="message_outbox.php"><i class="fa fa-send fa-fw m-r-5"></i> Sent</a></li>
                ...
                <div class="col-md-10">
                    <div class="email-btn-row hidden-xs">
                        ...
                        <a id="deleteSentMessages" href="operations/delete_all_sent_messages.php" class="btn btn-sm btn-danger <?php if($total_rows==0) echo "disabled"; ?>" data-toggle="tooltip" title="Click to delete all sent messages"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete All</a>
                        
                    </div>
                    <!-- start notification  -->
                    <?php 
//                 redirecting from 'delete_all_sent_messages.php'
...
<!--https://stackoverflow.com/questions/7474762/php-get-how-many-days-and-hours-left-from-a-date-->
                        <?php  
                        while($message = mysqli_fetch_assoc($sent_messages)){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="view_sent_message_detail.php?id=<?php echo $message['id']; ?>" class="email-btn" data-toggle="tooltip" title="Click to view the sent message"><i class="fa fa-eye"></i></a> 
                                                   
                                    <a href="operations/delete_sent_message.php?id=<?php echo $message['id']; ?>" class="email-btn m-l-1" data-toggle="tooltip" title="Click to delete the sent message permanently"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                            </tbody>
