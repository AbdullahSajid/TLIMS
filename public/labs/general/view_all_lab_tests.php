...
$tests_set = find_tests_by_lab($lab);
?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<head>
    <meta charset="utf-8"/>
    <title><?php echo $beautify_lab; ?> Tests Detail</title>
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        <li class="active"><a href="view_all_lab_tests.php">Tests Detail</a></li>
    ...
    <div id="content" class="content">
       <!-- begin breadcrumb -->
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="javascript:;">Tests List</a></li>
            <li class="active">View Tests List</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">View Tests List
            <small>View tests metadata and details of <?php echo $beautify_lab; ?></small>
        </h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title"><?php echo $beautify_lab; ?>Tests Detail</h4>
                    </div>
                    <!-- start notification  -->
                    <?php 
