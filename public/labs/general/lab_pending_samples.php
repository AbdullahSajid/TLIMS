...
<head>
    <meta charset="utf-8"/>
    <title>View Pending Samples Tests</title>
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        <li class="active"><a class="pending_samples_sub_indicator" href="lab_pending_samples.php">Pending Samples</a></li>
...
<script src="../../assets/js/lab_dashboard/lab_pending_samples_page.js"></script>
